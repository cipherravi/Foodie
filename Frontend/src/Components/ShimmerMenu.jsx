function ShimmerMenu() {
  return (
    <div className="SMcontainer min-w-screen min-h-screen flex flex-col items-center mt-5 lg:mt-10">
      <div className="SMbox  flex flex-col pt-1 justify-start items-center gap-7 w-3/4 h-full relative sm:w-[75%] md:w-[60%] lg:w-[50%] ">
        <div className="SMheading w-full h-9 flex items-end">
          <span className="bg-[#bdbcbc] w-40 h-6 block rounded-md"></span>
        </div>

        <div className="SMbanner relative bg-[#bdbcbc] rounded-2xl overflow-hidden h-36 w-full flex flex-col gap-4 pl-5 pt-5 ">
        ...
        <div className="font-mono text-xs">-Menu-</div>
        <div className=" w-full h-10 rounded-lg bg-[#dadada]"></div>

        <div className="SMmenucard relative  h-40 w-full bg-[#bdbcbc] mt-5 rounded-2xl flex justify-between items-center px-5">
          <div className="flex flex-col gap-4 w-10/12">
            <span className="w-28 h-4 bg-[#dadada] rounded-sm"></span>
          ...
          <div className="w-36 h-24 rounded-lg bg-[#dadada]"></div>
        </div>
        <div className="SMmenucard relative  h-40 w-full bg-[#bdbcbc] mt-4  rounded-2xl flex justify-between items-center px-5">
          <div className="flex flex-col gap-4 w-10/12">
            <span className="w-28 h-4 bg-[#dadada] rounded-sm"></span>
            <span className="w-14 h-4 bg-[#dadada] rounded-sm"></span>
            <span className="w-9/12 h-4 bg-[#dadada] rounded-sm"></span>
